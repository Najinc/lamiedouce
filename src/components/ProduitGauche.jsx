...
export default function ProduitGauche({ nom, description, autre, image }) {
    return (
        <div className="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl md:h-72 mx-2 my-10">
            ...
            <div className="z-0 order-1 md:order-1 relative w-full md:w-2/5 h-80 md:h-full overflow-hidden rounded-lg md:rounded-none md:rounded-l-lg">
                ...
                <svg
                    className="hidden md:block absolute inset-y-0 h-full w-24 fill-current text-white right-0 transform translate-x-12"
                    viewBox="0 0 100 100"
